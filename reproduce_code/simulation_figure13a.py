...
SIGMA_MAX = 260  # Adjusted maximum mental stress for this figure
...
# Find and annotate intersections
intersections = {}
...
# Final plot settings
plt.title("Figure 13a. Comparing Mental Capacities β = 0.7, 1.0, 1.3 under σ_max = 260", fontsize=14)
...
# Save figure
output_path = "../figures/figure13a_workload_efficiency_beta_0.7_1.0_1.3_sigmax260.png"
