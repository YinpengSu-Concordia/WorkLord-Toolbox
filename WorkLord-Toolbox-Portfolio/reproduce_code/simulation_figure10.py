...
def find_intersections(W_range, beta, sigma_max, epsilon_max, threshold=1.0, ignore_below=5):
...
# Final plot settings
plt.title("Figure 10. Comparison of Human and Ideal Workload–Efficiency Relations at β = 0.7, 1.0, 1.3", fontsize=14)
...
# Save figure
output_path = "../figures/figure10_workload_efficiency_comparison_beta_0.7_1.0_1.3.png"
