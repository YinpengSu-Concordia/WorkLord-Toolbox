...
EPSILON_MAX = 70  # Lower maximum efficiency for this comparison
...
# Final plot settings
plt.title("Figure 12b. Comparing Mental Capacities β = 0.7, 1.0, 1.3 under ε_max = 70", fontsize=14)
...
# Save figure
output_path = "../figures/figure12b_workload_efficiency_beta_0.7_1.0_1.3_epsmax70.png"
