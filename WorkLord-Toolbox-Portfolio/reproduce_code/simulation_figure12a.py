...
EPSILON_MAX = 130  # Updated maximum efficiency for this figure
...
# Intersection finder between efficiency curves
...
# Final plot settings
plt.title("Figure 12a. Comparing Mental Capacities β = 0.7, 1.0, 1.3 under ε_max = 130", fontsize=14)
...
# Save figure
output_path = "../figures/figure12a_workload_efficiency_beta_0.7_1.0_1.3_epsmax130.png"
